...
class ActionSection {
    ...
    downloadChecklist() {
        ...
        // Role and location display names
        const roleNames = {
            homeowner: '🏠 Homeowner',
            farmer: '🚜 Farmer',
            student: '📚 Student',
        ...
        let content = '';
        content += `================================================\n`;
        content += `        ECOROOT ACTION PLAN\n`;
        content += `================================================\n\n`;
        
        content += `YOUR PROFILE\n`;
        content += `------------------------------------------------\n`;
        content += `Role:     ${roleNames[this.selectedRole]}\n`;
        content += `Location: ${locationNames[this.selectedLocation]}\n`;
        content += `Date:     ${date}\n`;
        content += `------------------------------------------------\n\n`;
        ...
        planData.immediate.forEach((action, i) => {
            ...
            content += `      ${action.desc}\n`;
            content += `      Impact: ${'*'.repeat(Math.min(5, Math.ceil(action.impact/4)))}${'-'.repeat(5-Math.min(5, Math.ceil(action.impact/4)))}\n\n`;
        });

        content += `> SHORT-TERM GOALS (This Month)\n`;
        content += `------------------------------------------------\n`;
        ...
        content += `> LONG-TERM COMMITMENT (Ongoing)\n`;
        content += `------------------------------------------------\n`;
        ...
        // Calculate progress
        const totalActions = planData.immediate.length + planData.shortTerm.length + planData.longTerm.length;
        const completedCount = this.completedActions.length;
        const progressPercent = Math.round((completedCount / totalActions) * 100);

        content += `================================================\n`;
        content += `PROGRESS: ${completedCount}/${totalActions} actions completed (${progressPercent}%)\n`;
        content += `[${'#'.repeat(Math.floor(progressPercent/5))}${'.'.repeat(20-Math.floor(progressPercent/5))}]\n`;
        content += `================================================\n\n`;

        content += `------------------------------------------------\n`;
        content += `Generated by EcoRoot\n`;
        content += `Together, we can heal our planet!\n`;
        content += `\n`;
        content += `Visit us: ecoroot.rf.gd\n`;
        content += `------------------------------------------------\n`;
